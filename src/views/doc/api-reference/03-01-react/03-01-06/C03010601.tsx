...
class C030106 extends React.Component {
  public componentDidMount(): void {
     ...
     */
    console.log(
      React.Children.map<string, ReactChild>(element01.props.children, (child: React.ReactChild) => {
     ...
     */
    console.log(
      React.Children.map<number, React.ReactFragment>(element03.props.children, (child: React.ReactFragment) => {
